...
class MyPdf extends FPDF{
	...
	function viewTable() {
		...
		foreach ( $citas as $p ) {
			...
			$this->Cell(50 ,20 , $this->Image(($p[3] != "" && file_exists ( "img/" . $p[2] . "" ) && $p[2])?"img/".$p[2]:"img/user.jpg", $this->GetX()+1, $this->GetY()+1,45, 16) , 1);
			$this->Ln();
			$this->Cell(40 ,10 ,"Fecha" , 1, 0, "C");
			$this->Cell(40 ,10 ,"Hora" , 1, 0, "C");
			$this->Cell(120 ,10 ,"Medico" , 1, 0, "C");
			$this->Cell(35 ,10 ,"Consultorio" , 1, 0, "C");
			$this->Cell(40 ,10 ,"Especialidad" , 1, 0, "C");
			$this->Ln();
			$this->Cell(40 ,10 , $p[4] , 1, 0, "C");
			$this->Cell(40 ,10 , $p[5] , 1, 0, "C");
			$this->Cell(120 ,10 ,$p[6] , 1, 0, "C");
			$this->Cell(35 ,10 , $p[7] , 1, 0, "C");
			$this->Cell(40 ,10 , $p[8] , 1, 0, "C");
			$this->Ln();
		}
		$this->AddPage();
	}
