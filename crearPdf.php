...
class MyPdf extends FPDF{
	...
	function viewTable() {
		...
		foreach ( $pacientes as $p ) {
		    ...
		    $this->Cell(20 ,35 , $this->Image(($p->getEstado () == 1)?"img/check.jpg":"img/times.jpg", $this->GetX()+2, $this->GetY()+7,15, 20),1,"C");
		    $this->Cell(47 ,35 , $this->Image(($p->getFoto () != "" && file_exists ( "img/" . $p->getFoto () . "" ) && $p->getFoto ())?"img/".$p->getFoto():"img/user.jpg", $this->GetX()+1, $this->GetY()+1,45, 33),1);
		    $this->Ln();
		}
	}
}
